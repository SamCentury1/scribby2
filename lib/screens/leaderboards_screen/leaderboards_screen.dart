...
Widget getLeaderboard(List<Map<String,dynamic>> list, ColorPalette palette, Map<String,dynamic> user) {
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 18,
                                color: palette.textColor2,
                                fontWeight: checkIfUser(user,list[i]) ? FontWeight.w800 : FontWeight.normal
                              ),
                            )
                          )
                        ),
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(4.0),                    
                        child: Align(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            Helpers().capitalizeName(list[i]['username']),
                            style: TextStyle(
                              fontSize: 18,
                              color: palette.textColor2,
                              fontWeight: checkIfUser(user,list[i]) ? FontWeight.w800  : FontWeight.normal
