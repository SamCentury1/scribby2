        ...
        return DialogWidget(
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  _instructionsHeading(palette, "Objective",gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      ...
                      false),
                  _instructionsHeading(palette, "Demo",gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      "The two letters at the top are randomly generated. The center letter letter_1 gets placed next",
                      gamePlayState.currentLanguage,
                      true),
                  DemoBoardState(demoBoardState: demoBoardState_1, language: gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      "When the letter letter_1 is placed inside the board, the letter to the right letter_2 will become the center letter and a new random letter will be generated and take its spot",
                      gamePlayState.currentLanguage,
                      true),
                  _instructionsText(palette,
                      "A new letter letter_3 is randomly generated to be place after the next letter letter_2 is placed.",
                      gamePlayState.currentLanguage,
                      true),
                  DemoBoardState(demoBoardState: demoBoardState_2, language: gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      "Place your letters strategically to create words. In this case, we see the letter_4 coming after the letter_3",
                      gamePlayState.currentLanguage,
                      true),
                  DemoBoardState(demoBoardState: demoBoardState_3, language: gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      "The letter_3 is placed below the letter_2 so the letter_4 can be placed between the letter_1 and the letter_2 and create the word WORD",
                      gamePlayState.currentLanguage,
                      true),
                  DemoBoardState(demoBoardState: demoBoardState_4, language: gamePlayState.currentLanguage),
                  _instructionsText(palette,
                      "The letter_4 is placed in between the letter_1 and letter_2. The letters animate and you are granted points for the letters.",
                      gamePlayState.currentLanguage,
                      true),
                  _instructionsHeading(palette,
                      "Swipe to 'Settings' to understand how points are allocated",gamePlayState.currentLanguage),
...
Widget _instructionsHeading(ColorPalette palette, String body, String language) {
  String res = "";
...
Widget _instructionsText(ColorPalette palette, String body, String language, bool dynamicValue) {
  String res = "";
  if (dynamicValue) {
