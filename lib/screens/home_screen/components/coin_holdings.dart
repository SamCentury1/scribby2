...
class CoinHoldings extends StatefulWidget {
  const CoinHoldings({super.key});

  @override
  State<CoinHoldings> createState() => _CoinHoldingsState();
}



class _CoinHoldingsState extends State<CoinHoldings> {
          ...
          child: Stack(
            children: [
              Container(
                ...
                child: CustomPaint(
                  painter: CoinCounterPainter(isAnimating:isAnimating, progress1: progress1, progress2: progress2,scalor: scalor,palette: palette),
                ),
              ),
              Container(
                key: _containerKey,
...
class CoinCounterPainter extends CustomPainter {
