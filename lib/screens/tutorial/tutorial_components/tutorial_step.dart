...
//   // String getPreviousStepText(Map<String, dynamic> step) {
//   //   String res = "";
//   //   if (step['step'] != 35) {
//   //     res = step['text'];
//   //   }
...
//   double getFontSize(String textBody) {
//     double res = 18.0; 
//     if (textBody.length > 100 && textBody.length < 120) {
//       res = 16.0;
//     } else if (textBody.length >= 120) {
//       res = 14.0;
//     }
//     print(textBody.length.toDouble());
//     return res;
//   }
...
//         // String currentStepText = TutorialHelpers().translateTutorialStep(gamePlayState.currentLanguage, currentStep['text'],);
//         String currentStepText = currentStep['text'];
//         // getFontSize(currentStepText);

//         // previousStep = {}
//         // if ()
//         // Map<String, dynamic> previousStep = TutorialHelpers().getPreviousStep2(tutorialState);
//         // String previousStepText = TutorialHelpers().translateTutorialStep(gamePlayState.currentLanguage, previousStep['text'],);
...
//                                     // currentStep['text'],
//                                     style: TextStyle(
//                                         fontSize: getFontSize(currentStepText),
...
//                                   child: Text(
//                                     currentStepText,
//                                     // TutorialHelpers().translateTutorialStep(
...
//                               },
//                               child: Text(
//                                 Helpers().translateText(gamePlayState.currentLanguage, "Next"),
//                                 style: TextStyle(
