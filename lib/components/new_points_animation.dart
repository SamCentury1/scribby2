...
class _NewPointsAnimationState extends State<NewPointsAnimation> with TickerProviderStateMixin {
  ...
  void initializeAnimations() {
    ...
    final List<TweenSequenceItem<Color?>> newPointsTextSequence = [
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(0, 0, 0, 0), end: const Color.fromRGBO(255, 4, 4, 1),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(228, 0, 0, 1), end: const Color.fromRGBO(255, 212, 18, 1),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(255, 232, 28, 1), end: const Color(0xFFFF1212),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(228, 0, 0, 1), end: const Color.fromRGBO(255, 212, 18, 1),), weight: 0.1),   
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(228, 0, 0, 1), end: const Color.fromRGBO(255, 212, 18, 1),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(255, 232, 28, 1), end: const Color(0xFFFF1212),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(228, 0, 0, 1), end: const Color.fromRGBO(255, 212, 18, 1),), weight: 0.1),   
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(255, 232, 28, 1), end: const Color(0xFFFF1212),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(228, 0, 0, 1), end: const Color.fromRGBO(255, 212, 18, 1),), weight: 0.1),                  
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(255, 224, 47, 1), end: const Color.fromRGBO(0, 0, 0, 0),), weight: 0.1),
    ];

    _newPointsTextAnimation = TweenSequence<Color?>(
      newPointsTextSequence
    ...
    final List<TweenSequenceItem<Offset>> newPointsPositionSequence = [
      TweenSequenceItem<Offset>(tween: Tween(begin: Offset.zero, end: const Offset(0.0, -1.0)), weight: 1.0),
    ...
    _newPointsPositionAnimation = TweenSequence<Offset>(
      newPointsPositionSequence
    ...
    final List<TweenSequenceItem<Color?>> newPointsShadowSequence = [
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(0, 0, 0, 0), end: const Color.fromRGBO(0, 0, 0, 1),), weight: 0.1),
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(0, 0, 0, 1), end: const Color.fromRGBO(0, 0, 0, 1),), weight: 0.8),              
      TweenSequenceItem<Color?>(tween: ColorTween(begin: const Color.fromRGBO(0, 0, 0, 1), end: const Color.fromRGBO(0, 0, 0, 0),), weight: 0.1),
    ];

    _newPointsShadowAnimation = TweenSequence<Color?>(
      newPointsShadowSequence
    ...
    _newPointsFontSizeAnimation = TweenSequence<double>(
      newPointsFontSizeSequence
