...
class _BonusScoreElementsState extends State<BonusScoreElements> with TickerProviderStateMixin {
  ...
  void initializeAnimations() {
    ...
    _streakTextAnimation = TweenSequence<Color?>(
      streakTextTweenSequence
    ...
    final List<TweenSequenceItem<Offset>> itemSlideSequence = [
      TweenSequenceItem<Offset>( tween: Tween<Offset>(begin: const Offset(-1.2, 0.0),   end:  Offset.zero,), weight: 0.1 ),
      TweenSequenceItem<Offset>( tween: Tween<Offset>(begin: Offset.zero,   end:  Offset.zero,), weight: 0.8 ),
      TweenSequenceItem<Offset>( tween: Tween<Offset>(begin: Offset.zero,   end:  const Offset(0.0, -1.0),), weight: 0.1 ),
    ];    
    ...
    final List<TweenSequenceItem<Color?>> itemTextTweenSequence = [
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(0, 0, 0, 0),   end:  const Color.fromRGBO(202, 176, 228, 1),), weight: 0.4 ),
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(202, 176, 228, 1),   end:  const Color.fromRGBO(202, 176, 228, 1), ), weight: 0.1 ),
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(255, 45, 45, 1),   end:  const Color.fromRGBO(255, 251, 10, 1),), weight: 0.1 ),
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(255, 251, 10, 1),   end:  const Color.fromRGBO(255, 45, 45, 1),), weight: 0.1 ),      
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(255, 45, 45, 1),  end: const Color.fromRGBO(255, 251, 10, 1), ), weight: 0.1 ),
      TweenSequenceItem<Color?>( tween: ColorTween(begin: const Color.fromRGBO(255, 251, 10, 1),    end:  const Color.fromRGBO(0, 0, 0, 0),), weight: 0.2 ),
    ];
    _multiTextAnimation = TweenSequence<Color?>(
      itemTextTweenSequence
    ...
    _cwTextAnimation = TweenSequence<Color?>(
      cwTextTweenSequence
    ).animate(_cwTextController); 
    /// ============== SCOREBOARD TEXT COLOR ================
    /// ============== ^^^^^^^^^^^^^^^^ ======================         
      ...
      builder: (context, gamePlayState, child) {
              return Row(
                children: [
                  ...
                  gamePlayState.gameSummaryLog.isEmpty ? const SizedBox()
                                          ...
                                          return Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Icon(
                                                  Icons.electric_bolt,
                                                  color:_streakTextAnimation.value ?? const Color.fromRGBO(206, 0, 0, 1),
                                                ),
                                                ...
                                                Text(
                                                  ...
                                                  style: TextStyle(
                                                    ...
                                                    fontSize: 22,
                                                    color:_streakTextAnimation.value ?? const Color.fromRGBO(82, 31, 31, 1),
                                                  ),
                                                ),                                                    
                                              ],
                                            ),
                                            ...
                                            child: Row(
                                              children: [
                                                Icon(
                                                  ...
                                                  color:_multiTextAnimation.value ?? const Color.fromRGBO(206, 0, 0, 1 ),
                                                ),
                                                const Expanded(flex: 1, child: Center(),),
                                                Text(
                                                  ...
                                                  style: TextStyle(
                                                    fontStyle: FontStyle.italic,
                                                    fontSize: 22,
                                                    color: _multiTextAnimation.value ?? const Color.fromRGBO(211, 211, 211, 1),
                                                  ),
                                                ),
                                              ],
                                            ),
                                          ...
                                          return Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                Icon(
                                                  Icons.close,
                                                  color:_cwTextAnimation.value ?? const Color.fromRGBO(206, 0, 0, 1),
                                                ),
                                                const Expanded(flex: 1, child: Center(),),
                                                Text(
                                                  // "${widget.activeStreak.toString()}x",
                                                  ...
                                                  style: TextStyle(
                                                    fontStyle: FontStyle.italic,
                                                    fontSize: 22,
                                                    color: _cwTextAnimation.value ?? const Color.fromRGBO(211, 211, 211, 1),
                                                  ),
                                                ),                                                    
