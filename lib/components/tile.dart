...
class _TileState extends State<Tile> with TickerProviderStateMixin  {
  ...
  Map<String, dynamic> findTileState(state) {
    ...
    tileState = GameLogic().getTileState(state.visualTileState,"${(widget.row).toString()}_${(widget.column).toString()}" );
    return tileState;
  }

  Color colorTileBg(Map<String,dynamic> tileObject, bool darkTheme, ColorPalette palette) {
  ...
  Color colorTileBorder(Map<String,dynamic> tileObject, bool darkTheme, ColorPalette palette, Color? animatedColor) {
    late Color color = const Color.fromRGBO(0, 0, 0, 0);
    if (tileObject["active"]) {
      color = animatedColor!;
    } else {
        ...
        return AnimatedBuilder(
          ...
          return Center(
            ...
            child: Padding(
              ...
              child: Container(
                width: tileState["active"] ? _tileSizeAnimation.value : 50, // widget.tileState["active"] ? _tileSizeAnimation.value : 50,
                height: tileState["active"] ? _tileSizeAnimation.value : 50, // widget.tileState["active"] ? _tileSizeAnimation.value : 50,
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    ...
                    color: colorTileBorder(tileState, settings.darkTheme.value, palette, _letterBorderColorAnimation2.value),
                    width: 3
                  ),
                ...
                child: Center(
                  child: AnimatedDefaultTextStyle(
                    ...
                    style: TextStyle(
                      ...
                      color: tileState["active"] ?  _letterTextColorAnimation.value ?? const Color.fromRGBO(0, 0, 0, 1) : const Color.fromRGBO(0, 0, 0, 1),
                    ),
                    child: Text(
