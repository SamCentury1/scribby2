...
class Palette {
  ...
  Color get lightOptionButtonBgColor => const Color.fromARGB(255, 209, 209, 209);
  ...
  Color get lightBottomNavigationBarColor => const Color.fromARGB(255, 75, 3, 117);
  Color get lightBottomNavigationBarItemColor => const Color.fromARGB(255, 204, 204, 204);
  ...
  Color get lightModalNavigationBarBgColor => const Color.fromARGB(255, 78, 78, 78);
  Color get lightModalNavigationBarItemColor => const Color.fromARGB(255, 253, 214, 40);
  ...
  Color get darkOptionButtonTextColor => const Color.fromARGB(255, 209, 209, 209);
  ...
  Color get darkBottomNavigationBarColor => const Color.fromARGB(255, 63, 3, 97);
  Color get darkBottomNavigationBarItemColor => const Color.fromARGB(255, 253, 214, 40);
  ...
  Color get darkModalNavigationBarBgColor => const Color.fromARGB(255, 78, 78, 78);
  Color get darkModalNavigationBarItemColor => const Color.fromARGB(255, 218, 218, 218);
  ...
  void getThemeColors(bool isDarkTheme) {
    ...
    switch (isDarkTheme) {
      case true:
        ...
        _bottomNavigationBarColor = const Color.fromARGB(255, 63, 3, 97); 
        _bottomNavigationBarItemColor = const Color.fromARGB(255, 253, 214, 40); 
        ...
        break;
      case false:
        _screenBackgroundColor = const Color.fromARGB(255, 231, 216, 255); 
        ...
        _optionButtonTextColor = const Color.fromARGB(255, 242, 242, 243); 
        _tileBgColor = const Color.fromARGB(255, 117, 13, 187); 
        _tileBorderColor = const Color.fromARGB(255, 117, 13, 187); 
        _tileTextColor = const Color.fromARGB(255, 249, 181, 255); 
        _timerTextColor = const Color.fromARGB(255, 211, 211, 211); 
        _bottomNavigationBarColor = const Color.fromARGB(255, 75, 3, 117); 
        _bottomNavigationBarItemColor = const Color.fromARGB(255, 204, 204, 204); 
        _modalBgColor = const Color.fromARGB(255, 37, 1, 85); 
        _modalTextColor = const Color.fromARGB(255, 212, 211, 211); 
        _modalNavigationBarBgColor = const Color.fromARGB(255, 78, 78, 78); 
        _modalNavigationBarItemColor = const Color.fromARGB(255, 253, 214, 40);
