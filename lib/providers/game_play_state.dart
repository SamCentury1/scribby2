...
// ========================================
      ...
      {"step":25,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 26, "isStepCompleted":false, "newLetter":"W", "shouldStartCountDown": false,"perk":null, "delay":300, "message": "skip one tile"}, // S
      ...
      {"step":34,"type": "board", "moveType":"perk", "targetKey":null, "focusTile": 8, "isStepCompleted":false, "newLetter":null, "shouldStartCountDown": false, "perk":"explode", "delay":300, "message": "tap the bomb perk - then tap the blocked tile to free it up"},
      {"step":35,"type": "board", "moveType":"perk", "targetKey":null, "focusTile": 35, "isStepCompleted":false, "newLetter":null, "shouldStartCountDown": false, "perk":"explode", "delay":300, "message": "this also works for active letters - tap the bomb perk then selct the Q tile"},
      ...
      {"step":36,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 24, "isStepCompleted":false, "newLetter":"A", "shouldStartCountDown": false,"perk":null, "delay":300, "message": ""}, // B
      ...
      {"step":40,"type": "board", "moveType":"perk", "targetKey":null, "focusTile": 25, "isStepCompleted":false, "newLetter":null, "shouldStartCountDown": false,"perk":"freeze", "delay":300, "message": "select the freeze icon and then tap the L"}, // L
      {"step":41,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 28, "isStepCompleted":false, "newLetter":"M", "shouldStartCountDown": false,"perk":null, "delay":300, "message": "place the K"}, // K
      {"step":42,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 7, "isStepCompleted":false, "newLetter":"I", "shouldStartCountDown": false,"perk":null, "delay":300, "message": "Because the L is frozen, the word 'BLACK' is not counted until you un-freeze it"}, // S
      {"step":43,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 13, "isStepCompleted":false, "newLetter":"E", "shouldStartCountDown": false,"perk":null, "delay":300, "message": "This lets us create another word in the meantime"}, // M
      {"step":44,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 19, "isStepCompleted":false, "newLetter":"S", "shouldStartCountDown": false,"perk":null, "delay":300, "message": "This is a good strategy as crosswords double your points"}, // I
      ...
      {"step":46,"type": "board", "moveType":"perk", "targetKey":null, "focusTile": 25, "isStepCompleted":false, "newLetter":null, "shouldStartCountDown": false,"perk":"freeze", "delay":3000, "message": "Now we can complete the words 'BLACK' & 'SMILE' by un-freezing the L"}, // L
      ...
      {"step":49,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 20, "isStepCompleted":false, "newLetter":'S', "shouldStartCountDown": false,"perk":null, "delay":1000, "message": "You complete the word SEA but realize that you could have waited for the L to get SEAL"}, // S
      ...
      {"step":61,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 29, "isStepCompleted":false, "newLetter":"U", "shouldStartCountDown": false,"perk":null, "delay":300, "message": ""}, // E
      {"step":62,"type": "board", "moveType":"tap", "targetKey":null, "focusTile": 35, "isStepCompleted":false, "newLetter":"H", "shouldStartCountDown": false,"perk":null, "delay":300, "message": ""}, // S
      {"step":63,"type": "board", "moveType":"perk", "targetKey":null, "focusTile": 23, "isStepCompleted":false, "newLetter":null, "shouldStartCountDown": false,"perk":"swap", "delay":300, "message": "tap the swap perk icon"}, // 
